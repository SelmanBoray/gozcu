...
- Birleşik R@5: **0.333** · Yalnız-kare R@5: 0.333 · Yalnız-kırpık R@5: 0.0
- **Marjinal katkı (birleşik − kare): +0.000** (hedef ≥ 0.0: ✅)

## Golden-frame (gözle doğrulanmış tek kare)

- n=2 · Recall@1=0.0 (hedef 0.66) · Recall@5=0.0 · MRR=0.056
  - `v2_gold_meva_yuruyen` sıra=KAÇTI (dedup/kümeleme)
  - `v2_gold_meva_otopark` sıra=9
...
| v2_gold_meva_otopark | golden | araçlarla dolu açık otopark | ucf_trafik | 9 |
