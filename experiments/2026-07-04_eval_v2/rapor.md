...
- n=2 · Recall@1=0.0 (hedef 0.66) · Recall@5=0.0 · MRR=0.062
  - `v2_gold_meva_yuruyen` sıra=KAÇTI (dedup/kümeleme)
  - `v2_gold_meva_otopark` sıra=8
...
| v2_gold_meva_otopark | golden | araçlarla dolu açık otopark | ucf_trafik | 8 |
