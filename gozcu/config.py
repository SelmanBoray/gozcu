...
class Settings(BaseSettings):
    ...
    # Zaman grounding (AI Engineer #3): doğrulanmış sonuçları video+zaman-yakınlığıyla
    # OLAYlara kümele. Ardışık hit arası boşluk > event_gap_s → yeni olay. Kimlik takibi
    # YOK ("görülme aralığı", "girdi/çıktı" değil). Detay: ARCHITECTURE.md §9
    event_gap_s: float = 50.0        # olay bölme boşluğu (sn) — bunun üstü ayrı görülme
